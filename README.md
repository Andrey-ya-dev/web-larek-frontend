...
- `constructor(container: HTMLElement, events: IEvents)` Конструктор принимает элемент, по которому будут найдены элементы в нутри данного контейнера и экземпляр класса `EventEmitter` для возможности инициации событий.
